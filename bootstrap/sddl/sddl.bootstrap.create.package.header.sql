...
/* SPs */
SET TERM ^ ;
CREATE OR ALTER PACKAGE PKG$SDDL
AS
begin
  ...
  PROCEDURE SP_COMPLETE_CREATE_STAMP (
    ATablename DN_DB_OBJECT)
  RETURNS (
    SUCCESS DN_BOOLEAN);
  
  PROCEDURE SP_COMPLETE_FIELD_DESCRIPTION (
    ATablename DN_DB_OBJECT)
  RETURNS (
    SUCCESS DN_BOOLEAN);
...
/*   wird in SP_COMPLETE_CREATE_FOREIGN_KEY für die Implementation benötigt, 
     kann aber erst nach SP_COMPLETE_CREATE_FOREIGN_KEY selber implementiert werden/
